...
class _TvSeriesDetailPageState extends State<TvSeriesDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      Provider.of<TvSeriesDetailNotifier>(context, listen: false).loadTvSeriesWatchlistStatus(widget.id);
    });
  }
  @override
    ...
    return Scaffold(
      body: Consumer<TvSeriesDetailNotifier>(
        builder: (context, provider, child) {
          if (provider.tvseriesRecommendations == RequestState.Loading) {
            return Center(
              child: CircularProgressIndicator(),
            );
          } else if (provider.tvdetailState == RequestState.Loaded) {
            final tvSeries = provider.tvsdetail;
            return SafeArea(
              child: DetailContent(
                tvSeries,
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(_showDuration(
                              tvSeries.episodeRunTime.length == 0 
                              ? 0 : tvSeries.episodeRunTime[0]
                              ),
                            ),
                            Row(
                              children: [
